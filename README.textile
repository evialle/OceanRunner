...
A problem, with JUnit is that you may use multiple interesting Runners for a Test: *OceanRunner* tries to solve that problem.
By offering an easy way to integrate _"RunnersLik"e_ class, named _*OceanModule*_, you may conjugate many behaviors of unit testing strategy.
