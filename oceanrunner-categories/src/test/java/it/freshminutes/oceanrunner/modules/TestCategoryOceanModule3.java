...
import it.freshminutes.oceanrunner.tests.categories.Category2ToDoNotUse;
...
public class TestCategoryOceanModule3 {
	...
	@Test
	@Category(Category2ToDoNotUse.class)
	public void testCategoryToDoNotUse4() {
		Assert.fail("Do not execute that method");
	}
	
	@Test
	@Category(Category2ToDoNotUse.class)
	public void testCategoryToDoNotUse5() {
		Assert.fail("Do not execute that method");
	}
}
